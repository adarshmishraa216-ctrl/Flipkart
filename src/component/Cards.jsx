...
const Cards = () => {
  return (
    <>
      <div className="w-full bg-gray-100 flex  items-center p-8">
        {/* Wrapper for all cards */}
        <div className="flex space-x-6 gap-15">
          {/* Card 1 */}
          <div className="bg-white rounded-lg shadow-lg p-6 w-full">
            <div className="flex items-center space-x-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-500 text-sm mb-4">Min. 50% Off</p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 w-full">
            <div className="flex items-center space-x-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-500 text-sm mb-4">Upto 40% Off</p>
                <button className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded-lg transition-colors">
                  Shop Now
                </button>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6  w-full">
            <div className="flex items-center space-x-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-500 text-sm mb-4">Flat 30% Off</p>
                <button className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded-lg transition-colors">
                  Shop Now
                </button>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6  w-full">
            <div className="flex items-center space-x-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-500 text-sm mb-4">Upto 40% Off</p>
                <button className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded-lg <RiSpeedMiniFill />">
                  Shop Now
                </button>
              </div>
            </div>
      ...
      <footer className="bg-gray-800 text-white py-8 mt-8">
        <div className="w-full mx-auto px-4 flex justify-between gap-6">
          {/* Links Section */}
